...
#define TOUCH_CONTROLLER_NAME           "ST123"
#define TOUCH_ROTATION_TYPE             TOUCH_ROTATION_MIPI_DSI
#define TOUCH_CONTROLLER_TYPE_ST7123     1
...
#elif defined(TOUCH_CONTROLLER_TYPE_ST7123)
    esp_lcd_panel_io_i2c_config_t tp_io_config = ESP_LCD_TOUCH_IO_I2C_ST7123_CONFIG();
    tp_io_config.scl_speed_hz = HW_I2C_CLK_SPEED_HZ;
    ESP_ERROR_CHECK(esp_lcd_new_panel_io_i2c(s_touch_i2c_bus, &tp_io_config, &tp_io_handle));
    return esp_lcd_touch_new_i2c_st7123(tp_io_handle, &tp_cfg, ret_touch);
