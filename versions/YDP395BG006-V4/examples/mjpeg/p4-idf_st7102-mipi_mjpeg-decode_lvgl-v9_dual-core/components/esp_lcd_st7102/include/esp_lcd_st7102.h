 ...
 */
typedef struct {
    const st7102_lcd_init_cmd_t *init_cmds;    /*!< Pointer to initialization commands array.
 ...
 *
 */
#define ST7102_PANEL_BUS_SPI_CONFIG(sclk, mosi, max_trans_sz)  \
    {                                                           \
        .sclk_io_num = sclk,                                    \
        .mosi_io_num = mosi,                                    \
        .miso_io_num = -1,                                      \
...
#define ST7102_PANEL_BUS_QSPI_CONFIG(sclk, d0, d1, d2, d3, max_trans_sz)\
    {                                                           \
        .sclk_io_num = sclk,                                    \
        .data0_io_num = d0,                                     \
        .data1_io_num = d1,                                     \
 ...
 *
 */
#define ST7102_PANEL_IO_3WIRE_SPI_CONFIG(line_cfg, scl_active_edge) \
    {                                                               \
 ...
 *
 */
#define ST7102_PANEL_IO_SPI_CONFIG(cs, dc, cb, cb_ctx)         \
    {                                                           \
        .cs_gpio_num = cs,                                      \
        .dc_gpio_num = dc,                                      \
        .spi_mode = 0,                                          \
...
#define ST7102_PANEL_IO_QSPI_CONFIG(cs, cb, cb_ctx)            \
    {                                                           \
        .cs_gpio_num = cs,                                      \
        .dc_gpio_num = -1,                                      \
        .spi_mode = 0,                                          \
 ...
 *
 */
#define ST7102_480_480_PANEL_60HZ_RGB_TIMING()                 \
    {                                                           \
 ...
 *
 */
#define ST7102_MIPI_PANEL_BUS_DSI_2CH_CONFIG()                \
    {                                                          \
        .bus_id = 0,                                           \
        .num_data_lanes = 2,                                   \
 ...
 *
 */
#define ST7102_MIPI_PANEL_IO_DBI_CONFIG()  \
    {                                       \
        .virtual_channel = 0,               \
        .lcd_cmd_bits = 8,                  \
        .lcd_param_bits = 8,                \
 ...
 *
 */
#define ST7102_MIPI_480_480_PANEL_60HZ_DPI_CONFIG(px_format) \
    {                                                         \
