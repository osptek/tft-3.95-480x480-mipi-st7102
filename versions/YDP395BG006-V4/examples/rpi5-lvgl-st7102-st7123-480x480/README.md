# Raspberry Pi 5 · ST7102 + ST7123 · LVGL（480×480）

本目录为 3.95″ ST7102 MIPI 模组在 Raspberry Pi 5 上跑 **LVGL（lv_port_linux / DRM + EVDEV）** 的参考：含显示/触摸内核模块、DT overlay，以及替换 `lv_port_linux` 用的 `main.c`。
...
| `Makefile` | 内核模块编译 |
| `vc4-kms-dsi-st7102-480x480-st7123-overlay.dts` | DSI + 触摸 overlay |
| `main.c` | 拷入 `lv_port_linux/src/main.c` 的参考实现（默认 480×480 / DRM / EVDEV） |

仅点亮显示+触摸、不跑 LVGL 时，也可只用同级 [`../rpi5-panel-st7102-st7123-480x480/`](../rpi5-panel-st7102-st7123-480x480/)。
...
```bash
dtc -@ -I dts -O dtb -o vc4-kms-dsi-st7102-480x480-st7123-overlay.dtbo vc4-kms-dsi-st7102-480x480-st7123-overlay.dts
sudo cp vc4-kms-dsi-st7102-480x480-st7123-overlay.dtbo /boot/firmware/overlays/
```
...
dtoverlay=vc4-kms-dsi-st7102-480x480-st7123-overlay
